export const Empty = () => {
    return (
        <div className="text-[300px] grid place-items-center overflow-hidden flex-auto">
            <p className="">
                <svg
                    fill="white"
                    version="1.1"
                ...
                >
                    <g>
                        <path
                            d="M0.952,16.282c-1.212-1.133-1.274-3.033-0.142-4.246c1.132-1.213,3.018-1.291,4.247-0.143
